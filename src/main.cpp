...
bool InitializeDirectX() {
    ...
    HRESULT result =
        D3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr, createDeviceFlags, &featureLevel, 1, D3D11_SDK_VERSION, &g_pDevice, &chosenFeatureLevel, &g_pDeviceContext);
...
#ifdef WIN32
    HWND hwnd = (HWND)SDL_GetPointerProperty(SDL_GetWindowProperties(g_pWindow), SDL_PROP_WINDOW_WIN32_HWND_POINTER, NULL);
